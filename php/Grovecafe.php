 ...
 <!--Bussiness time-->        
        <p1>Bussiness time: 
            ...
            <?php
                ...
                $query="SELECT * FROM business_time WHERE Cafe='Grove'";
                  ...
                  <form id="order" class="trolley_iteam" action="./cart.php" method="post" onsubmit="return order_validation();"><fieldset>
                      ...
                      <?php
                        if (isset($_SESSION['state']) && $_SESSION['state'] == "login") {
                            ...
                            $query = "SELECT * FROM grove_cafe_temp_cart_list WHERE Cart_id='$_SESSION[id]'";
    ...
    <!--Master food menu-->    
		<div class="masterfood">
		  <div class="row">
			<?php
              //GET ITEAMS
                $sql = "SELECT * FROM grove_cafe_iteam WHERE Type='MASTER_FOOD'";
    ...
    <!--Beverage menu-->          
        <div class="beverage">
		  <div class="row">
			 ...
			 <?php
              //GET ITEAMS
                $sql = "SELECT * FROM grove_cafe_iteam WHERE Type='BEVERAGE'";
                $res = $mysqli->query($sql);
